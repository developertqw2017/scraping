...
class DmozSpider(CrawlSpider):
    ...
    start_urls = [
        ...
        "http://www.xfxw.com.cn/yaowen/index.jhtml",
        "http://www.xfxw.com.cn/yaowen/index_2.jhtml",
        "http://www.xfxw.com.cn/yaowen/index_3.jhtml",
        "http://www.xfxw.com.cn/yaowen/index_4.jhtml"
    ]

    rules = (
        Rule(LinkExtractor(allow=(r'yaowen/[0-9]{5}\.jhtml$')),callback='parse_1',follow=True),
    )

    def parse_1(self, response):
        for sel in response.xpath('//div[@class="mainBody"]/h2/text()'):
            title = sel.extract()
